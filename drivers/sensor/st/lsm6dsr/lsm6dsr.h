...
#define LSM6DSR_MASK_CTRL1_XL_ODR_XL			(BIT(7) | BIT(6) | \
							 BIT(5) | BIT(4))
...
#define LSM6DSR_MASK_CTRL2_G_ODR_G			(BIT(7) | BIT(6) | \
							 BIT(5) | BIT(4))
...
#define LSM6DSR_MASK_CTRL3_C_BLE			BIT(1)
#define LSM6DSR_SHIFT_CTRL3_C_BLE			1
